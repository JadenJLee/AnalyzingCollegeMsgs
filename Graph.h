...
public:
    ...
    // adds to the vector of indices for Kruskals
    // labels each vertex with a number
    void addIndex(Vertex v);

    // gets the index of the selected vector
...
private:
    ...
    mutable unordered_map<Vertex, int> indexVertex;
